...
struct mokinys{
    string vardas;
    string pavarde;
    vector<long long> tarpiniaiRezultatai;
...
void VidurkioSkaiciavimas(vector<mokinys>&, int , double & , long long);
void MedianosSkaiciavimas(vector<mokinys> & , double & , long long );
